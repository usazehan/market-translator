...
class EbaySandboxClient(ChannelClient):
    """
    Minimal eBay-like sandbox adapter.
    ...
    Auth: Bearer token (EBAY_TOKEN) if present.
    """
    ...
    @classmethod
    def from_env(cls) -> "EbaySandboxClient":
        base = os.environ["EBAY_BASE_URL"]
